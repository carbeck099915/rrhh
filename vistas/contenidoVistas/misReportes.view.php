  ...
  <main class="clear contenedor__de__paginas"> 
    ...
    <div class="contenedor__tablas__secuencia">
      ...
      <input type="hidden" name="idRolRecuperadicimos" id="idRolRecuperadicimos" value="<?php   echo $idRolRecuperadicimos; ?>">
       ...
       <table id="tablaTeletrabajoDirectorMis" name="tablaTeletrabajoDirectorMis" class="cell-border tabla__registro__gimnacios">
...
<div id="editarActividadesTeletrabajoMis" class="modal animated bounceIn" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <table id="tablaTeletrabajoDirectorMis" name="tablaTeletrabajoDirectorMis" class="cell-border">

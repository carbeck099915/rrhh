<?php 
  ...
  $AreaUsuario=$nombreObjeto->recuperandoAreaPuesto();  
?>
                          ...
                          <div class="panel panel-info paraGeneral">
                            <div class="panel-heading">Información</div>
                              <div class="panel-body"> 
                                ...
                                <textarea name="infopermiso" id="infopermiso" class="form-control inpunt-lg" readonly></textarea>
      ...
      <table style="border: 0">
        ...
        <tr>
          ...
          <td style="width: 50%">      
           ...
           <td id="imagenPrevia" class="pequeña">
           </td>
           <td id="verPdfq" class="pdfUsuuu">
           </td>      
        ...
        <tr>
          <td colspan="2"><center>
            <button type="button" class="btn btn-info" id="enviarPermisoDir" name="enviarPermisoDir">Enviar</button></center>
          </td>  
        </tr>

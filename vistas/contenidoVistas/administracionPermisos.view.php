...
<div class="wrapper row3"> 
    ...
    <table id="tablaPermisos" name="tablaPermisos">
		<thead>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="fa fa-thumbs-down btn btn-danger" name="negarPermiso" id="negarPermiso">NEGAR</button>
        ...
        <button type="button" class="fa fa-hand-stop-o btn btn-warning" name="anularPermisoth" id="anularPermisoth">ANULAR</button>
         ...
         <button type="button" class="fa fa-thumbs-up btn btn-success" data-dismiss="modal" name="aprobarPermiso" id="aprobarPermiso">APROBAR</button>


         <button type="button" class="fa fa-save btn btn-link" data-dismiss="modal" name="guardarNegacion" id="guardarNegacion">GUARDAR</button>


         <button type="button" class="fa fa-save btn btn-link" data-dismiss="modal" name="guardarAnulacion" id="guardarAnulacion">GUARDAR</button>


         <button type="button" class="fa fa-save btn btn-link" data-dismiss="modal" name="CancelarNegacionTh" id="CancelarNegacionTh">Cancelar</button>

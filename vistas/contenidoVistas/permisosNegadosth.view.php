...
<div class="wrapper row3">
	...
	<div class="contenedor__tablas contenedor__tablas__polifacetico__usuarios" style="width:90%;">
	  ...
	  <table id="tablaNegadoTh" name="tablaNegadoTh">
		<thead>
      ...
      <div class="modal-footer">
       <table class="table table-striped table-dark">
         <tr>
           ...
           <td colspan="3"><textarea name="ObservacionNegado" id="ObservacionNegado" readonly class="form-control inpunt-lg"></textarea> </td>
         </tr>
         <tr>
            <td style="width: 25%"><label class="">Persona que Negó: </label></td>
           <td> <input class="form-control inpunt-lg" type="text" name="perNega" id="perNega" readonly></td>
         </tr>
         <tr>

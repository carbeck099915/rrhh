...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">Agregar</button>
      ...
      <table id="tablaRoles2Funcionarios" name="tablaRoles2Funcionarios">
    ...
    <div class="modal-content" style="width:130%!important;">
      ...
      <div class="modal-header">
        ...
        <div style="text-align: center; width: 100%; font-weight: bold;">
          ...
          HORARIO DE ENTRADA Y SALIDA POR FUNCIONARIO
      ...
      <div class="modal-body">
        ...
        <div class="contenedor__horasAlmuerzo">
          ...
          <div class="elementos__columna">
            ...
            <label>Escoger Físicamente estructura</label>

            <select id="fisicamenteEstructura" class="form-control obligagorios">
        ...
        <div class="elementos__columna__2 ocultos__funcionarios">
      ...
      <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary" id="idRegistrarHorasFuncionarios">Registrar</button>

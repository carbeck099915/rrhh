  ...
  <div class="wrapper row2 estilo__fondo__header">
    ...
    <nav id="mainav" class="clear menu__moviendo"> 
      ...
      <ul class="clear estilo__menu__contenido">
        ...
        <li><a href="administracionFuncionarios" class="estilo__menu__contenido">Solicitar Permiso</a></li>
        <li><a href="permisosPorUsuarios" class="estilo__menu__contenido">Historial Permisos</a></li>
        <li><a href="paginaInicial" class="estilo__menu__contenido">Menú Principal</a></li>
        
        <!-- <li><a href="vacacionesFuncionario">Vacaciones</a></li> -->

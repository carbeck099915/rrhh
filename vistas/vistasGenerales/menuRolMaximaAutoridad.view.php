<?php 
  ...
  $conteo=$nombreObjeto->recuperandoCountMx();
...
<body id="top">
  ...
  <div class="wrapper row2 estilo__fondo__header"> 
    ...
    <nav id="mainav">  
      ...
      <ul class="clear menu__moviendo" style="border:none!important;">
        ...
        <li><a class="drop menu__moviendo" href="#" style="border:none!important;">Permisos <font size ="3", color ="#ff0000" class="btn btn-circle-micro btn-danger"><?php echo $conteo; ?></font> </a>
            
             <ul>
                 <li><a href="administracionPermisosMAutoridad" class="menu__moviendo style="border:none!important;"">Pendiente</a></li>
                 <li><a href="permisosAprobadosMax" class="menu__moviendo" style="border:none!important;">Aprobados</a></li>
        ...
        <li><a href="salir2" class="menu__moviendo" style="border:none!important;">Salir</a></li>

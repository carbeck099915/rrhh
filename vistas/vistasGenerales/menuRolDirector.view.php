<?php 
  ...
  $conteo=$nombreObjeto->recuperandoCountDir();
  ...
  <div class="wrapper row2 estilo__fondo__header">
    ...
    <nav id="mainav" > 
      ...
      <ul class="clear estilo__menu__contenido">
        ...
        <li><a href="administracionDirectores" class="estilo__menu__contenido">Solicitar Permiso</a></li>
        
        <li><a href="permisosPorUsuariosDir" class="estilo__menu__contenido">Historial Permisos</a></li>
        <li><a class="drop estilo__menu__contenido" href="#">Permisos 
          <font size ="3", color ="#ff0000" class="btn btn-circle-micro btn-danger"><?php echo $conteo; ?></font> 
        </a>
            
             <ul>
                 <li><a href="administracionPermisosDirector" class="estilo__menu__contenido">Pendiente</a></li>
                 <li><a href="permisosAprobadosDir" class="estilo__menu__contenido">Aprobados</a></li>
